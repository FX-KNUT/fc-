...
const comp_children__wallet = (
    <div id={styles.wallet_description_body}>
      ...
      <div id={styles.wallet_coins_wrapper}>
        <div className={`${styles.wallet_coins_container} ${styles.wallet_example}`}>
          <div className={`${styles.wallet_coin__title} ${styles.wallet_example}`}>코인명</div>
          <div className={`${styles.wallet_coin__price} ${styles.wallet_example}`}>
            <span className={styles.wallet_coin__price__have}>
              주당 가격 
            </span>
          </div>
          <div className={`${styles.wallet_coin__stock} ${styles.wallet_example}`}>수량</div>
          <div className={`${styles.wallet_coin__total} ${styles.wallet_example}`}>총계</div>
          <div className={`${styles.wallet_coin__average_price} ${styles.wallet_example}`}>평단가</div>
          <div className={`${styles.wallet_coin__profit_ratio} ${styles.wallet_example}`}>수익률</div>
        </div>
        {/* Array.map()을 시작하세요 */}
        <div className={styles.wallet_coins_container}>
          ...
          <div className={styles.wallet_coin__price}>
            ...
            <div className={styles.spacer}></div>
            <span className={styles.wallet_coin__price__unit}>
              USD
            </span>
          </div>
          ...
          <div className={styles.wallet_coin__total}>
            ...
            <div className={styles.spacer}></div>
            <span className={styles.wallet_coin__price_unit}>
              USD
            </span>
          </div>
